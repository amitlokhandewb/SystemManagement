...
namespace SystemManagementApp.Migrations
{
    ...
    [Migration("20240826121000_added perisson")]
    partial class addedperisson
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SystemManagementApp.Model.PagePermission", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SystemManagementApp.Model.RoleMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SystemManagementApp.Model.PagePermission", b =>
                {
                    b.HasOne("SystemManagementApp.Model.UserRole", "UserRole")
                        .WithMany()
                        .HasForeignKey("roleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SystemManagementApp.Model.RoleMapping", "RoleMapping")
                        .WithMany()
